...
const MainHeader = ({
    ...
    const getBasePath = () => {
        ...
        if (path.startsWith('/product-info')) return '/product-info';
    ...
    const handleNew = () => {
        if (onNew) {
            ...
            if (currentPath.startsWith('/product-info')) {
                // Signal Product Info page to clear its storage
                sessionStorage.setItem('clear_product_info_state', 'true');
