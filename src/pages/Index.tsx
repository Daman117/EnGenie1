...
const Index = () => {
  ...
  const [loadedProjectData, setLoadedProjectData] = useState<any>(() => {
    try {
      ...
      return {
        ...
        productSearchWorkflow: restoredState.productSearchWorkflow || {
          threadId: null,
          currentPhase: null,
      ...
      try {
        ...
        if (searchHistory) {
          ...
          setLoadedProjectData({
            ...
            productSearchWorkflow: searchHistory.productSearchWorkflow || {
              threadId: null,
              currentPhase: null,
              awaitingUserInput: false,
              missingFields: []
  ...
  const handleSaveProject = useCallback(async (
    ...
    try {
      ...
      // Enforce (Search) suffix for projects saved from this screen
      const effectiveProjectName = `${baseName} (Search)`;
      ...
      const projectData = {
        ...
        conversation_histories: {
          'search': {
            ...
            productSearchWorkflow: state.productSearchWorkflow || null
          }
        },
  ...
  return (
    <>
      <AIRecommender
        ...
        savedProductSearchWorkflow={loadedProjectData?.productSearchWorkflow}
      />
